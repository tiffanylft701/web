                ...
                <div class="tab-main">
                  <el-form 
                    ...
                    <div class="login-text">
                      登录即同意相关服务条款和隐私政策 <a>《小鹿线用户服务协议》</a
                      ><a>《小鹿线隐私政策》</a>
                ...
                <div class="tab-main">
                  ...
                  >
                    ...
                    <el-form-item class="login-Verification" prop="captcha">
                      ...
                      <el-button @click="sendCode" class="btn btn-primary sendcaptcha" type="primary"
                        >{{ captcha }}</el-button>
                    </el-form-item>
                    <div class="login-submit">
                      <el-button class="btn btn-primary sendcaptcha " @click='phoneBtn(ruleFormRefPhone)'  type="primary"
                        >登录</el-button
                      >
                    </div>
                    <div class="login-text">
...
let rules = reactive({
  username: [
    { reaquired: true, message: "请输入用户名", trigger: "blur" },
...
let rulesPhone = reactive({
  phone: [
    { reaquired: true, message: "请输入手机号", trigger: "blur" },
    { pattern: /^1[3-9]\d{9}$/, message: "目前只支持中国大陆手机号码", },
  ],
  captcha: [
